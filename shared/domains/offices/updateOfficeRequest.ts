...
export const UpdateOfficeRequestBodySchema = z.object({ arr: z.number().min(1).max(20).optional(), description: z.string().optional(), isFake: z.boolean().optional(), lat: z.number().optional(), lng: z.number().optional(), posts: z.number().optional(), price: z.number().optional(), services: z.any().optional(), slug: z.string().optional(), title: z.string().optional() });

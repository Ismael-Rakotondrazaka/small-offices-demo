...
export const StoreOfficeRequestBodySchema = z.object({ arr: z.number().min(1).max(20), description: z.string(), isFake: z.boolean(), lat: z.number(), lng: z.number(), posts: z.number(), price: z.number(), services: z.any(), slug: z.string(), type: OfficeTypeSchema });
